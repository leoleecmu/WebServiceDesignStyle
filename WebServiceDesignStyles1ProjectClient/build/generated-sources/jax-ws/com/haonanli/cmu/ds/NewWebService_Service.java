 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://ds.cmu.haonanli.com/", wsdlLocation = "http://localhost:8080/WebServiceDesignStyles1ProjectServer/NewWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://ds.cmu.haonanli.com/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebServiceDesignStyles1ProjectServer/NewWebService?WSDL");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://ds.cmu.haonanli.com/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ds.cmu.haonanli.com/", "NewWebServicePort"), NewWebService.class, features);
    }
